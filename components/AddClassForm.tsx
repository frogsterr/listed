    ...
    <div className="max-w-lg mx-auto px-4 py-6">
      ...
      {!showForm ? (
        ...
        <div className="bg-white border border-cream-border rounded-xl p-5 flex flex-col gap-4">
          ...
          <label className="text-xs text-gray-500">Verified requirements (comma-separated; leave blank if unknown)
            <input value={requirements} onChange={e => setRequirements(e.target.value)} className="w-full border border-cream-border rounded-lg p-2 mt-1" />
          </label>
